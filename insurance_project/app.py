...
class UserInput(BaseModel):
    ...
    def lifestyle_risk(self) -> str:
        if self.smoker and self.bmi > 30:  # FIXED: removed ["smoker"]
            return "high"
...
async def predict_premium(data: UserInput):
    ...
    try:
        ...
        class_probabilities = dict(zip(model.classes_, probabilities.tolist()))
    except:
    ...
    response = {
        ...
        "confidence": None if class_probabilities is None else max(class_probabilities.values()),
